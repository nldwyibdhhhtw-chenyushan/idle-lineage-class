 ...
 * ========================================================================== */
const CODE_VERSION = 'code-1dfb76254a4d';   // ← scripts/stamp-sw-version.mjs 自動覆寫,勿手改(只用來讓 sw.js 內容變動→觸發更新偵測,不是桶名)
const BUILD_ID     = '0824-1425'; // ← stamp 在 CODE_VERSION 變動時一起更新成台灣時間 MMDD-HHMM(僅供畫面辨識版本)

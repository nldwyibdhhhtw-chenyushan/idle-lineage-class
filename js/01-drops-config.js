    ...
    [
        ['妖魔', 'relic_orc_lid', 10],
        ['哥布林', 'relic_goblin_blade', 10],
        ['妖魔弓箭手', 'relic_orcarcher_bow', 10],
        ...
        ['牧羊犬', 'relic_shepherd_boots', 10],
        ['人形殭屍', 'relic_zombie_shin', 10],
        ['杜賓狗', 'relic_doberman_fang', 10],
        ['安普長老', 'relic_amp_staff', 10],
        ['污染的安特', 'relic_ent_bark', 10],
        ['漂浮之眼', 'relic_eye_crystal', 10],
        ['妖魔鬥士', 'relic_gladiator_scimitar', 10],
        ['冰原狼人', 'relic_icefield_pick', 10],
        ['怪手', 'relic_monsterhand_skin', 10],
        ['狼人', 'relic_werewolf_mace', 10],
        ['侏儒戰士', 'relic_dwarf_chainmail', 10],
        ['骷髏', 'relic_weathered_skull', 10],
        ['妖魔殭屍', 'relic_orc_nail', 10],
        ['甘地妖魔', 'relic_orc_gloves', 10],
        ['污染的潘', 'relic_pan_staff', 10],
        ['鱷魚', 'relic_croc_tshirt', 10],
        ['冰之女王侍女', 'relic_maid_gift', 10],
        ['巨蟻', 'relic_giantant_antenna', 10],
        ['妖魔法師', 'relic_orcmage_cloth', 10],
        ...
        ['妖魔巡守', 'relic_scout_scope', 10],
        ['哈柏哥布林', 'relic_hobgoblin_grinder', 10],
        ['阿吐巴妖魔', 'relic_orc_butcher', 10],
        ['都達瑪拉妖魔', 'relic_orc_pole', 10],
        ['歐熊', 'relic_bear_fur', 10],
        ['蜥蜴人', 'relic_lizard_shield', 10],
        ['穴居人', 'relic_caveman_webbing', 10],
        ['史巴托', 'relic_sparta_grudge', 10],
        ['食屍鬼', 'relic_ghoul_bracelet', 10],
        ['鯊魚', 'relic_shark_teeth', 10],
        ['黑騎士', 'relic_guard_towershield', 10],
        // 🏺 遺物 第二批（v3.1.1·29 件）
        ['黑騎士搜索隊', 'relic_guard_spear', 10],
        ['人魚', 'relic_mermaid_tear', 10],
        ['那魯加妖魔', 'relic_orc_loincloth', 10],
        ['萊肯', 'relic_crescent_earring', 10],
        ['楊果里恩', 'relic_ungoliant_plate', 10],
        ['蟹人', 'relic_crab_claw', 10],
        ['狂野之毒', 'relic_wild_mane_coat', 10],
        ['狂野毒牙', 'relic_venom_fang', 10],
        ['歐姆', 'relic_ohm_shackle', 10],
        ['巨大兵蟻', 'relic_soldierant_carapace', 10],
        ['鼠人', 'relic_ratman_skewer', 10],
        ['海星', 'relic_starfish_arm', 10],
        ['遺忘之島鱷魚', 'relic_croc_soul', 10],
        ['遺忘之島蜥蜴人', 'relic_lizard_scale', 10],
        ['狂暴蜥蜴人', 'relic_veteran_lizard_gauntlet', 10],
        ['狂野之魔', 'relic_black_gale', 10],
        ['長老', 'relic_elder_thunder', 10],
        ['卡司特', 'relic_green_imp_nail', 10],
        ['狂暴的歐姆', 'relic_ohm_hidepants', 10],
        ['食人妖精', 'relic_ogre_mawashi', 10],
        ['蛇女', 'relic_lamia_tailscale', 10],
        ['魔蝙蝠', 'relic_bat_wing', 10],
        ['底比斯 曼陀羅草(白)', 'relic_mandra_spirit', 10],
        ['歐姆裝甲兵', 'relic_ohm_heavyarmor', 10],
        ['地獄犬', 'relic_cerberus_wand', 10],
        ['希爾黛斯', 'relic_watersprite_string', 10],
        ['龍龜', 'relic_dragonturtle_shell', 10],
        ['藍尾蜥蜴', 'relic_bluetail_tail', 10],
        ['重裝蜥蜴人', 'relic_lizardman_cleaver', 10],
        // 🏺 遺物 第三批（v3.1.2·19 件）
        ['狂暴的歐姆裝甲兵', 'relic_ohm_maul', 10],
        ['闇之精靈', 'relic_darkspirit_shroud', 10],
        ['犰狳', 'relic_armadillo_helm', 10],
        ['白螞蟻群', 'relic_whiteant_shell', 10],
        ['高等蜥蜴人', 'relic_high_lizard_armguard', 10],
        ['奇異鸚鵡', 'relic_parrot_beak', 10],
        ['海賊骷髏', 'relic_pirate_scimitar', 10],
        ['毒蠍', 'relic_scorpion_sting', 10],
        ['哈維', 'relic_harvey_claw', 10],
        ['底比斯 曼陀羅草', 'relic_death_leaf', 10],
        ['黑暗妖精魔法學徒', 'relic_apprentice_wand', 10],
        ['魔熊', 'relic_bear_vitality', 10],
        ['歐姆民兵', 'relic_militia_armor', 10],
        ['骷髏神射手', 'relic_sharpshooter_bow', 10],
        ['骷髏警衛', 'relic_guard_pike', 10],
        ['黑暗精靈', 'relic_whirlwind_xbow', 10],
        ['黑暗妖精殘兵(弓)', 'relic_darkremnant_boots', 10],
        ['歐吉', 'relic_ogi_greataxe', 10],
        ['多羅', 'relic_doro_vitality', 10],
        // 🏺 遺物 第四批（v3.1.4）
        ...
        ['海賊骷髏士兵', 'relic_seawater_shirt', 10],
        ['骷髏鬥士', 'relic_fighter_axe', 10],
        ['奎斯坦修', 'relic_hermitcrab_shell', 10],
        ['爆彈花', 'relic_bombflower_core', 10],
        ['底比斯 聖甲蟲', 'relic_scarab_shin', 10],
        ['黑暗妖精殘兵(劍)', 'relic_darkelf_grindblade', 10],
        ['黑暗妖精殘兵(十字弓)', 'relic_darkelf_shootglove', 10],
        ['巨人', 'relic_giant_clubfrag', 10],
        ['食人妖精王', 'relic_ogreking_collar', 10],
        ['莫妮亞', 'relic_monia_sandals', 10],
        ['艾爾摩士兵', 'relic_wornout_underwear', 10],
        ['夢幻之島蘑菇', 'relic_dream_mushroom_soul', 10],
        // 🏺 遺物 第六批（v3.1.13·11 件）
        ['夢幻之島鬼火', 'relic_wisp_remnant', 10],
        ['冰人', 'relic_frostdeath_breath', 10],
        ['黑暗妖精殘兵(法師)', 'relic_remnant_barrier', 10],
        ...
        ['冰石高崙', 'relic_icestone_maul', 10],
        ['底比斯 聖甲蟲(藍)', 'relic_scarab_nest', 10],   // 🏺 v3.1.16：聖甲蟲的孵育巢（aggroHide 迴避仇恨盾）
        // 🏺 遺物 第七批（v3.1.18·17 件）
        ['黑法師', 'relic_blackmage_pants', 10],
        ['變種蛇女', 'relic_mutant_lamia_scale', 10],
        ['海賊骷髏刀手', 'relic_pirate_bandana', 10],
        ['海賊骷髏首領', 'relic_pirate_ring', 10],
        ['巨人戰士', 'relic_giant_toothpick', 10],
        ['巨人長老', 'relic_giant_throwstone', 10],
        ['卡司特王', 'relic_redimp_nail', 10],
        ['活鎧甲', 'relic_armor_spareblade', 10],
        ['多眼怪', 'relic_beholder_gaze', 10],
        ['龍蠅', 'relic_fly_curse', 10],
        ['冰原老虎', 'relic_whitetiger_coat', 10],
        ['雪怪', 'relic_yeti_foot', 10],
        ['變形怪', 'relic_shapeshifter_underwear', 10],
        ['黑暗妖精殘兵(雙手劍)', 'relic_veteran_greatsword', 10],
        ['變種楊果里恩', 'relic_thorn_needle', 10],
        ['黑暗棲林者', 'relic_thorn_curse', 10],
        ['亞力安', 'relic_cockatrice_gaze', 10],
        // 🏺 遺物 第八批（v3.1.21·3 件）
        ['遺忘之島狼人', 'relic_moonhowl_helm', 10],
        ['遺忘之島夏洛伯', 'relic_poison_vial', 10],
        ['強化白螞蟻群', 'relic_ant_incubessence', 10],
        // 🏺 遺物 第九批（v3.1.28·10 件）
        ['阿魯巴', 'relic_aruba_haste', 10],
        ['火焰戰士', 'relic_ashwarrior_flamesword', 10],
        ['艾爾摩將軍', 'relic_deadgeneral_greatsword', 10],
        ['鋼鐵高崙', 'relic_steel_bulwark', 10],
        ['強盜頭目', 'relic_raider_belt', 10],
        ['底比斯 凱比斯(黑)', 'relic_darkscorpion_pincers', 10],
        ['遺忘之島黑暗精靈', 'relic_forgotten_sniperbow', 10],
        ['遺忘之島歐熊', 'relic_arrowfur_cloak', 10],
        ['邪惡蜥蜴', 'relic_evillizard_eye', 10],
        ['火焰弓箭手', 'relic_flamearcher_bracer', 10],   // 🏺 烈焰射手的護腕：spec 掉落源寫成物品名·取同義同級的 火焰弓箭手(fire_archer)
        // 🏺 遺物 第十批（v3.1.32·5 件）
        ['黑暗妖精警衛(十字弓)', 'relic_modded_crossbow', 10],
        ['梅杜莎', 'relic_medusa_stinger', 10],
        ['遺忘之島卡司特', 'relic_silent_venom', 10],
        ['思克巴', 'relic_charm_heart', 10],
        ['死亡之劍', 'relic_swordsman_underwear', 10],
        // 🏺 遺物 第十一批（v3.1.33·5 件）
        ['恐怖的火炎蛋', 'relic_fireegg_orb', 10],
        ['遺忘之島蛇女', 'relic_venom_avatar', 10],
        ['遺忘之島萊肯', 'relic_lycan_swiftlegs', 10],
        ['遺忘之島巨斧牛人', 'relic_axetaurus_brutalaxe', 10],
        ['遺忘之島食人妖精', 'relic_troll_belly', 10],
        // 🏺 遺物 第五批新增（v3.1.52·19 件）
        ['炎魔的思克巴', 'relic_burning_love', 10],
        ['巨大突擊螞蟻', 'relic_fearless_charge', 10],
        ['火蜥蜴', 'relic_lizard_tongue', 10],
        ['夢幻之島火蜥蜴', 'relic_flame_avatar', 10],
        ['夢幻之島殺人蜂', 'relic_killerbee_sting', 10],
        ['夢幻之島暴走兔', 'relic_runaway_carrot', 10],
        ['夢幻之島冰人', 'relic_frost_avatar', 10],
        ['黑暗妖精巡守', 'relic_handy_quiver', 10],
        ['黑暗妖精士兵', 'relic_soldier_medal', 10],
        ['邪惡密密', 'relic_evilchest_relic', 10],
        ['遺忘之島楊果里恩', 'relic_ancient_spider_claw', 10],
        ['火炎蛋', 'relic_flame_belt', 10],
        ['夢幻之島閃電球', 'relic_thunder_crown', 10],
        ['夢幻之島鎧甲守衛', 'relic_guardian_greatsword', 10],
        ['夢幻之島火炎蛋', 'relic_dream_flamesoul', 10],
        ['夢幻之島冰石高崙', 'relic_frost_stone_shield', 10],
        ['底比斯 凱比斯(紅)', 'relic_redscorpion_ring', 10],
        ...
        ['獨眼巨人', 'relic_jack_sling', 10],
        ['夢魘', 'relic_endless_nightmare', 10],
        ['夢幻之島大鬼火', 'relic_dullahan_ember', 10],
        ['黑暗妖精警衛(矛)', 'relic_guard_roughgloves', 10],
        ['黑虎', 'relic_blacktiger_whip', 10],
        ['地獄束縛犬', 'relic_hellhound_chain', 10],
        ['拉斯塔巴德守門人', 'relic_gatekeeper_boots', 10],
        ['黑暗妖精法師', 'relic_dark_manaball', 10],
        ['魔狼', 'relic_blackmane_coat', 10],
        ['恐怖夢魘', 'relic_wearying_dream', 10],
        ['地之牙', 'relic_earthfang_core', 10],
        ['風之牙', 'relic_windfang_breeze', 10],
        ['水之牙', 'relic_waterfang_tear', 10],
        ['火之牙', 'relic_firefang_ember', 10],
        ['馴獸師', 'relic_tamer_dogclub', 10],
        ['巨大強化白螞蟻', 'relic_healer_wand', 10],
        ['思克巴女皇', 'relic_succubus_temptation', 10],
        ['影魔', 'relic_shadow_stinger', 10],
        ['底比斯 尖碑石奴', 'relic_weathered_obelisk', 10],
        ['魂騎士', 'relic_soulreaper_dual', 10],
        ['遺忘之島格利芬', 'relic_griffin_feather', 10],
        ['遺忘之島鏈鎚牛人', 'relic_minotaur_flail', 10],
        ['遺忘之島哈維', 'relic_vigor_belt', 10],
        ['炎魔的思克巴女皇', 'relic_succubus_wand', 10],
        ['鬼魂', 'relic_wisp_thought', 10],
        ['巫師', 'relic_warlock_grimoire', 10],
        // 🐾 v3.2.17 夥伴更新遺物（第十四批·12 件·新捕捉動物 0.0001%）
        ['老虎', 'relic_tiger_fur', 10],
        ['貓', 'relic_cat_paw', 10],
        ['熊貓', 'relic_panda_eyes', 10],
        ['高麗幼犬', 'relic_pup_fang', 10],
        ['浣熊', 'relic_raccoon_leaf', 10],
        ['聖伯納犬', 'relic_stbernard_barrel', 10],
        ['狐狸', 'relic_fox_scarf', 10],
        ['暴走兔', 'relic_rabbit_foot', 10],
        ['小獵犬', 'relic_beagle_nose', 10],
        ['柯利', 'relic_collie_fur', 10],
        ['袋鼠', 'relic_kangaroo_gloves', 10],
        ['猴子', 'relic_monkey_staff', 10],
    ].forEach(function (r) { (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], r[2]]); });
    // 🏺 v3.5.27 遺物第十八批掉落（5 件·各 0.0001%·push 追加安全）
    [
        ['暗黑黑騎士', 'relic_bk_lance', 10],
        ['水靈之主', 'relic_water_orb', 10],
        ['遺忘之島阿魯巴', 'relic_broken_halfhelm', 10],
        ['遺忘之島食人妖精王', 'relic_fire_hide', 10],
        ['深淵食屍鬼', 'relic_ghoul_visage', 10],
    ].forEach(function (r) { (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], r[2]]); });
